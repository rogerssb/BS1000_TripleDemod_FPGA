...
create_generated_clock -name cAndD0/dllClk -source [get_pins cAndD0/dll/dllOutputClk_reg/Q] -divide_by 4 [get_pins cAndD0/dllClk_reg/Q]
create_generated_clock -name cAndD0/pllClk -source [get_ports pll0_OUT1] -divide_by 4 [get_pins cAndD0/pllClk_reg/Q]

set_clock_groups -name AllClocks -asynchronous -group [get_clocks -include_generated_clocks differentialClk] -group [get_clocks -include_generated_clocks singleEndedClk] -group [get_clocks -include_generated_clocks sysClk] -group [get_clocks -include_generated_clocks pll0_OUT1] -group [get_clocks -include_generated_clocks pll1_OUT1] -group [get_clocks -include_generated_clocks pll2_OUT1] -group [get_clocks -include_generated_clocks fbClk] -group [get_clocks virtual_clock] -group [get_clocks {cAndD0/dll/dllOutputClk cAndD0/dllClk {cAndD0/dllDivider_reg_n_0_[0]} cAndD0/pllClk {cAndD0/pllDivider_reg_n_0_[0]} cAndD1/dll/dllOutputClk {cAndD1/dllDivider_reg_n_0_[0]} {cAndD1/pllDivider_reg_n_0_[0]} cAndD2/dll/dllOutputClk {cAndD2/dllDivider_reg_n_0_[0]} {cAndD2/pllDivider_reg_n_0_[0]}}]

set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets framerMux/mux4]
