...
if {[file isfile LDPC_Div.autotvin.dat]} {
	file delete -force LDPC_Div.autotvin.dat
}

if {[file isfile LDPC_Div.autotvout.dat]} {
	file delete -force LDPC_Div.autotvout.dat
}
