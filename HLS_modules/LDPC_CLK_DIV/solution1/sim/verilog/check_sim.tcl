...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.LDPC_Div.autotvin_reset.dat"
         "c.LDPC_Div.autotvin_clk_div.dat"
         "c.LDPC_Div.autotvin_block_V.dat"
         "c.LDPC_Div.autotvout_rd_clk_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.LDPC_Div.autotvout_rd_clk_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
