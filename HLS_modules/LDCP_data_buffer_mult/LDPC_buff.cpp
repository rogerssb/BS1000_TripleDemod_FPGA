...
static tab_int  ccsds;
static unsigned int irig=3 ;
...
{
	unsigned int bit1, bit4, bit6, bit8, bit15, bit14, new_bit, xor_bit;
	int8_t irig_data;
...
//				*mux = mux_pos;
		...
		case 2:											// IRIG De-Randomizer
			bit14 = (irig & 0b10000000000000U);
			bit15 = (irig & 0b100000000000000U) >> 1;
