...
if {[file isfile LDPC_buff.autotvin.dat]} {
	file delete -force LDPC_buff.autotvin.dat
}

if {[file isfile LDPC_buff.autotvout.dat]} {
	file delete -force LDPC_buff.autotvout.dat
}
