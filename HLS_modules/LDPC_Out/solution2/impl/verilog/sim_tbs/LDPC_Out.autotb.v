...
`define AUTOTB_TVIN_reset  "./c.LDPC_Out.autotvin_reset.dat"
`define AUTOTB_TVIN_block_V  "./c.LDPC_Out.autotvin_block_V.dat"
`define AUTOTB_TVIN_rd_clk_in  "./c.LDPC_Out.autotvin_rd_clk_in.dat"
`define AUTOTB_TVIN_mem_out0  "./c.LDPC_Out.autotvin_mem_out0.dat"
`define AUTOTB_TVIN_mem_out1  "./c.LDPC_Out.autotvin_mem_out1.dat"
`define AUTOTB_TVIN_mem_out2  "./c.LDPC_Out.autotvin_mem_out2.dat"
`define AUTOTB_TVIN_mem_out3  "./c.LDPC_Out.autotvin_mem_out3.dat"
`define AUTOTB_TVIN_mem_out4  "./c.LDPC_Out.autotvin_mem_out4.dat"
`define AUTOTB_TVIN_mem_out5  "./c.LDPC_Out.autotvin_mem_out5.dat"
`define AUTOTB_TVIN_mem_out6  "./c.LDPC_Out.autotvin_mem_out6.dat"
`define AUTOTB_TVIN_mem_out7  "./c.LDPC_Out.autotvin_mem_out7.dat"
`define AUTOTB_TVIN_reset_out_wrapc  "./rtl.LDPC_Out.autotvin_reset.dat"
`define AUTOTB_TVIN_block_V_out_wrapc  "./rtl.LDPC_Out.autotvin_block_V.dat"
`define AUTOTB_TVIN_rd_clk_in_out_wrapc  "./rtl.LDPC_Out.autotvin_rd_clk_in.dat"
`define AUTOTB_TVIN_mem_out0_out_wrapc  "./rtl.LDPC_Out.autotvin_mem_out0.dat"
`define AUTOTB_TVIN_mem_out1_out_wrapc  "./rtl.LDPC_Out.autotvin_mem_out1.dat"
`define AUTOTB_TVIN_mem_out2_out_wrapc  "./rtl.LDPC_Out.autotvin_mem_out2.dat"
`define AUTOTB_TVIN_mem_out3_out_wrapc  "./rtl.LDPC_Out.autotvin_mem_out3.dat"
`define AUTOTB_TVIN_mem_out4_out_wrapc  "./rtl.LDPC_Out.autotvin_mem_out4.dat"
`define AUTOTB_TVIN_mem_out5_out_wrapc  "./rtl.LDPC_Out.autotvin_mem_out5.dat"
`define AUTOTB_TVIN_mem_out6_out_wrapc  "./rtl.LDPC_Out.autotvin_mem_out6.dat"
`define AUTOTB_TVIN_mem_out7_out_wrapc  "./rtl.LDPC_Out.autotvin_mem_out7.dat"
`define AUTOTB_TVOUT_data_out  "./c.LDPC_Out.autotvout_data_out.dat"
`define AUTOTB_TVOUT_cur_read_pos_V  "./c.LDPC_Out.autotvout_cur_read_pos_V.dat"
`define AUTOTB_TVOUT_data_out_out_wrapc  "./impl_rtl.LDPC_Out.autotvout_data_out.dat"
`define AUTOTB_TVOUT_cur_read_pos_V_out_wrapc  "./impl_rtl.LDPC_Out.autotvout_cur_read_pos_V.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_mem_out0 = 512;
parameter LENGTH_mem_out1 = 512;
parameter LENGTH_mem_out2 = 512;
parameter LENGTH_mem_out3 = 512;
parameter LENGTH_mem_out4 = 512;
parameter LENGTH_mem_out5 = 512;
parameter LENGTH_mem_out6 = 512;
parameter LENGTH_mem_out7 = 512;
...
wire  rd_clk_in;
wire  rd_mux;
wire [8 : 0] mem_out0_address0;
wire  mem_out0_ce0;
wire [0 : 0] mem_out0_q0;
wire [8 : 0] mem_out1_address0;
wire  mem_out1_ce0;
wire [0 : 0] mem_out1_q0;
wire [8 : 0] mem_out2_address0;
wire  mem_out2_ce0;
wire [0 : 0] mem_out2_q0;
wire [8 : 0] mem_out3_address0;
wire  mem_out3_ce0;
wire [0 : 0] mem_out3_q0;
wire [8 : 0] mem_out4_address0;
wire  mem_out4_ce0;
wire [0 : 0] mem_out4_q0;
wire [8 : 0] mem_out5_address0;
wire  mem_out5_ce0;
wire [0 : 0] mem_out5_q0;
wire [8 : 0] mem_out6_address0;
wire  mem_out6_ce0;
wire [0 : 0] mem_out6_q0;
wire [8 : 0] mem_out7_address0;
wire  mem_out7_ce0;
...
wire    [8 : 0]    arraymem_out0_address0, arraymem_out0_address1;
...
wire    [8 : 0]    arraymem_out1_address0, arraymem_out1_address1;
...
wire    [8 : 0]    arraymem_out2_address0, arraymem_out2_address1;
...
wire    [8 : 0]    arraymem_out3_address0, arraymem_out3_address1;
...
wire    [8 : 0]    arraymem_out4_address0, arraymem_out4_address1;
...
wire    [8 : 0]    arraymem_out5_address0, arraymem_out5_address1;
...
wire    [8 : 0]    arraymem_out6_address0, arraymem_out6_address1;
...
wire    [8 : 0]    arraymem_out7_address0, arraymem_out7_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.LDPC_Out.autotvout_data_out.dat", "r");
    fp2 = $fopen("./impl_rtl.LDPC_Out.autotvout_data_out.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.LDPC_Out.autotvout_data_out.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.LDPC_Out.autotvout_data_out.dat\"!");
    else begin
        $display("Comparing rtl.LDPC_Out.autotvout_data_out.dat with impl_rtl.LDPC_Out.autotvout_data_out.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.LDPC_Out.autotvout_cur_read_pos_V.dat", "r");
    fp2 = $fopen("./impl_rtl.LDPC_Out.autotvout_cur_read_pos_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.LDPC_Out.autotvout_cur_read_pos_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.LDPC_Out.autotvout_cur_read_pos_V.dat\"!");
    else begin
        $display("Comparing rtl.LDPC_Out.autotvout_cur_read_pos_V.dat with impl_rtl.LDPC_Out.autotvout_cur_read_pos_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
