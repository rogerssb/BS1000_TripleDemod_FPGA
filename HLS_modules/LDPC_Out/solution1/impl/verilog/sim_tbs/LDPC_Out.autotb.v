...
`define AUTOTB_TVIN_numbits_V  "./c.LDPC_Out.autotvin_numbits_V.dat"
...
`define AUTOTB_TVIN_numbits_V_out_wrapc  "./rtl.LDPC_Out.autotvin_numbits_V.dat"
...
`define AUTOTB_TVOUT_rd_mux  "./c.LDPC_Out.autotvout_rd_mux.dat"
...
`define AUTOTB_TVOUT_rd_mux_out_wrapc  "./impl_rtl.LDPC_Out.autotvout_rd_mux.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.LDPC_Out.autotvout_rd_mux.dat", "r");
    fp2 = $fopen("./impl_rtl.LDPC_Out.autotvout_rd_mux.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.LDPC_Out.autotvout_rd_mux.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.LDPC_Out.autotvout_rd_mux.dat\"!");
    else begin
        $display("Comparing rtl.LDPC_Out.autotvout_rd_mux.dat with impl_rtl.LDPC_Out.autotvout_rd_mux.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
