set C_TypeInfoList {{ 
"LDPC_Out" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"data_out": [[],{ "pointer":  {"scalar": "bool"}}] }, {"reset": [[], {"scalar": "bool"}] }, {"cur_read_pos": [[],{ "pointer": "0"}] }, {"numbits": [[],"0"] }, {"rd_clk_in": [[], {"scalar": "bool"}] }, {"rd_mux": [[],{ "pointer":  {"scalar": "bool"}}] }, {"mem_out0": [[], {"array": [ {"scalar": "bool"}, [2048]]}] }, {"mem_out1": [[], {"array": [ {"scalar": "bool"}, [2048]]}] }, {"mem_out2": [[], {"array": [ {"scalar": "bool"}, [1024]]}] }, {"mem_out3": [[], {"array": [ {"scalar": "bool"}, [1024]]}] }, {"mem_out4": [[], {"array": [ {"scalar": "bool"}, [1024]]}] }, {"mem_out5": [[], {"array": [ {"scalar": "bool"}, [1024]]}] }, {"mem_out6": [[], {"array": [ {"scalar": "bool"}, [1024]]}] }, {"mem_out7": [[], {"array": [ {"scalar": "bool"}, [1024]]}] }],[],""], 
"0": [ "tab_int", {"typedef": [[[],"1"],""]}], 
...
set C_modelArgList {
	...
	{ rd_mux int 1 regular {pointer 1}  }
	{ mem_out0 int 1 regular {array 2048 { 1 3 } 1 1 }  }
	{ mem_out1 int 1 regular {array 2048 { 1 3 } 1 1 }  }
	{ mem_out2 int 1 regular {array 1024 { 1 3 } 1 1 }  }
	{ mem_out3 int 1 regular {array 1024 { 1 3 } 1 1 }  }
	{ mem_out4 int 1 regular {array 1024 { 1 3 } 1 1 }  }
	{ mem_out5 int 1 regular {array 1024 { 1 3 } 1 1 }  }
	{ mem_out6 int 1 regular {array 1024 { 1 3 } 1 1 }  }
	{ mem_out7 int 1 regular {array 1024 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "data_out","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "rd_mux", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "rd_mux","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "mem_out0", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "mem_out0","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 2047,"step" : 1}]}]}]} , 
 	{ "Name" : "mem_out1", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "mem_out1","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 2047,"step" : 1}]}]}]} , 
 	{ "Name" : "mem_out2", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "mem_out2","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 1023,"step" : 1}]}]}]} , 
 	{ "Name" : "mem_out3", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "mem_out3","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 1023,"step" : 1}]}]}]} , 
 	{ "Name" : "mem_out4", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "mem_out4","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 1023,"step" : 1}]}]}]} , 
 	{ "Name" : "mem_out5", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "mem_out5","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 1023,"step" : 1}]}]}]} , 
 	{ "Name" : "mem_out6", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "mem_out6","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 1023,"step" : 1}]}]}]} , 
 	{ "Name" : "mem_out7", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "mem_out7","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 1023,"step" : 1}]}]}]} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rd_mux", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rd_mux", "role": "default" }} , 
 	{ "name": "rd_mux_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "rd_mux", "role": "ap_vld" }} , 
 	{ "name": "mem_out0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "mem_out0", "role": "address0" }} , 
 	...
 	{ "name": "mem_out1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "mem_out1", "role": "address0" }} , 
 	...
 	{ "name": "mem_out2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mem_out2", "role": "address0" }} , 
 	...
 	{ "name": "mem_out3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mem_out3", "role": "address0" }} , 
 	...
 	{ "name": "mem_out4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mem_out4", "role": "address0" }} , 
 	...
 	{ "name": "mem_out5_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mem_out5", "role": "address0" }} , 
 	...
 	{ "name": "mem_out6_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mem_out6", "role": "address0" }} , 
 	...
 	{ "name": "mem_out7_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mem_out7", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		{"Name" : "rd_mux", "Type" : "Vld", "Direction" : "O"},
		...
		{"Name" : "read_cnt_start", "Type" : "OVld", "Direction" : "IO"},
...
set Spec2ImplPortList { 
	...
	rd_mux { ap_vld {  { rd_mux out_data 1 1 }  { rd_mux_ap_vld out_vld 1 1 } } }
	mem_out0 { ap_memory {  { mem_out0_address0 mem_address 1 11 }  { mem_out0_ce0 mem_ce 1 1 }  { mem_out0_q0 mem_dout 0 1 } } }
	mem_out1 { ap_memory {  { mem_out1_address0 mem_address 1 11 }  { mem_out1_ce0 mem_ce 1 1 }  { mem_out1_q0 mem_dout 0 1 } } }
	mem_out2 { ap_memory {  { mem_out2_address0 mem_address 1 10 }  { mem_out2_ce0 mem_ce 1 1 }  { mem_out2_q0 mem_dout 0 1 } } }
	mem_out3 { ap_memory {  { mem_out3_address0 mem_address 1 10 }  { mem_out3_ce0 mem_ce 1 1 }  { mem_out3_q0 mem_dout 0 1 } } }
	mem_out4 { ap_memory {  { mem_out4_address0 mem_address 1 10 }  { mem_out4_ce0 mem_ce 1 1 }  { mem_out4_q0 mem_dout 0 1 } } }
	mem_out5 { ap_memory {  { mem_out5_address0 mem_address 1 10 }  { mem_out5_ce0 mem_ce 1 1 }  { mem_out5_q0 mem_dout 0 1 } } }
	mem_out6 { ap_memory {  { mem_out6_address0 mem_address 1 10 }  { mem_out6_ce0 mem_ce 1 1 }  { mem_out6_q0 mem_dout 0 1 } } }
	mem_out7 { ap_memory {  { mem_out7_address0 mem_address 1 10 }  { mem_out7_ce0 mem_ce 1 1 }  { mem_out7_q0 mem_dout 0 1 } } }
}
