...
if {[file isfile LDPC_Out.autotvin.dat]} {
	file delete -force LDPC_Out.autotvin.dat
}

if {[file isfile LDPC_Out.autotvout.dat]} {
	file delete -force LDPC_Out.autotvout.dat
}
