...
if {[file isfile HLSLdpcLogDecScaledMin.autotvin.dat]} {
	file delete -force HLSLdpcLogDecScaledMin.autotvin.dat
}

if {[file isfile HLSLdpcLogDecScaledMin.autotvout.dat]} {
	file delete -force HLSLdpcLogDecScaledMin.autotvout.dat
}
