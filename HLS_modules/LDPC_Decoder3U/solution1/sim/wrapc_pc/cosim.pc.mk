...
$(ObjDir)/LDPC_Decoder_check.cpp_pre.cpp.tb.o : LDPC_Decoder_check.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling LDPC_Decoder_check.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/HLSLdpcLogDecScaledMin.cpp_pre.cpp.tb.o : HLSLdpcLogDecScaledMin.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling HLSLdpcLogDecScaledMin.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
