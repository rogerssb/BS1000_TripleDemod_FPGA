...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.LDPC_CTRL.autotvin_block_V.dat"
         "c.LDPC_CTRL.autotvin_code_V.dat"
         "c.LDPC_CTRL.autotvin_run.dat"
         "c.LDPC_CTRL.autotvin_init_done.dat"
         "c.LDPC_CTRL.autotvin_init_ready.dat"
         "c.LDPC_CTRL.autotvout_init_start.dat"
         "c.LDPC_CTRL.autotvout_buff_start.dat"
         "c.LDPC_CTRL.autotvout_status_V.dat"
         "c.LDPC_CTRL.autotvout_err_code.dat"
         "c.LDPC_CTRL.autotvout_size_V.dat"
         "c.LDPC_CTRL.autotvout_rate_V.dat"
         "c.LDPC_CTRL.autotvout_buff_reset.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.LDPC_CTRL.autotvout_init_start.dat"
         "rtl.LDPC_CTRL.autotvout_buff_start.dat"
         "rtl.LDPC_CTRL.autotvout_status_V.dat"
         "rtl.LDPC_CTRL.autotvout_err_code.dat"
         "rtl.LDPC_CTRL.autotvout_size_V.dat"
         "rtl.LDPC_CTRL.autotvout_rate_V.dat"
         "rtl.LDPC_CTRL.autotvout_buff_reset.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
