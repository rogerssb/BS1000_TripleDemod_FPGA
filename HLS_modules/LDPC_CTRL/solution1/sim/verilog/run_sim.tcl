...
if {[file isfile LDPC_CTRL.autotvin.dat]} {
	file delete -force LDPC_CTRL.autotvin.dat
}

if {[file isfile LDPC_CTRL.autotvout.dat]} {
	file delete -force LDPC_CTRL.autotvout.dat
}
