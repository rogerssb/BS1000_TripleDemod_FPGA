...
entity setupLDPC_load_etaIndexM is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of setupLDPC_load_etaIndexM is 
    ...
    signal read_3_fu_170_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_s_fu_256_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and not((exitcond1_fu_144_p2 = ap_const_lv1_0)))) then 
                loop_1_reg_98 <= ap_const_lv5_0;
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (ap_const_lv1_0 = exitcond2_fu_176_p2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and not((ap_const_lv1_0 = tmp_9_fu_198_p2)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond1_fu_144_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and not((ap_const_lv1_0 = exitcond2_fu_176_p2)))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, exitcond1_fu_144_p2, tmp_9_fu_198_p2, exitcond_fu_225_p2, exitcond2_fu_176_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st2_fsm_1 => 
                if ((exitcond1_fu_144_p2 = ap_const_lv1_0)) then
                    ap_NS_fsm <= ap_ST_st2_fsm_1;
                else
                    ap_NS_fsm <= ap_ST_st3_fsm_2;
                end if;
            when ap_ST_st3_fsm_2 => 
                if ((ap_const_lv1_0 = exitcond2_fu_176_p2)) then
                    ap_NS_fsm <= ap_ST_st3_fsm_2;
                else
                    ap_NS_fsm <= ap_ST_st4_fsm_3;
                end if;
            when ap_ST_st4_fsm_3 => 
                if ((ap_const_lv1_0 = tmp_9_fu_198_p2)) then
                    ap_NS_fsm <= ap_ST_st1_fsm_0;
                else
    ...
    ap_done_assign_proc : process(ap_start, ap_sig_cseq_ST_st1_fsm_0, ap_sig_cseq_ST_st4_fsm_3, tmp_9_fu_198_p2)
    begin
        if (((not((ap_const_logic_1 = ap_start)) and (ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0)) or ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and (ap_const_lv1_0 = tmp_9_fu_198_p2)))) then 
    ...
    ap_ready_assign_proc : process(ap_sig_cseq_ST_st4_fsm_3, tmp_9_fu_198_p2)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and (ap_const_lv1_0 = tmp_9_fu_198_p2))) then 
    ...
    clk_ap_vld_assign_proc : process(ap_sig_cseq_ST_st4_fsm_3, tmp_9_fu_198_p2)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and (ap_const_lv1_0 = tmp_9_fu_198_p2))) then 
    ...
    cs_ap_vld_assign_proc : process(ap_sig_cseq_ST_st4_fsm_3, tmp_9_fu_198_p2)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) and (ap_const_lv1_0 = tmp_9_fu_198_p2))) then 
    ...
    -- dout assign process. --
    dout_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, exitcond1_fu_144_p2, ap_sig_cseq_ST_st3_fsm_2, read_reg_87, exitcond2_fu_176_p2)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (ap_const_lv1_0 = exitcond2_fu_176_p2))) then 
            dout <= ap_const_lv1_0;
        elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond1_fu_144_p2 = ap_const_lv1_0))) then 
    ...
    dout_ap_vld_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, exitcond1_fu_144_p2, ap_sig_cseq_ST_st3_fsm_2, exitcond2_fu_176_p2)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (exitcond1_fu_144_p2 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (ap_const_lv1_0 = exitcond2_fu_176_p2)))) then 
    ...
    etaIndexM_V_address0 <= tmp_s_fu_256_p1(16 - 1 downto 0);

    -- etaIndexM_V_ce0 assign process. --
    etaIndexM_V_ce0_assign_proc : process(ap_sig_cseq_ST_st5_fsm_4)
    begin
    ...
    etaIndexM_V_d0 <= p_s_reg_121;

    -- etaIndexM_V_we0 assign process. --
    etaIndexM_V_we0_assign_proc : process(ap_sig_cseq_ST_st5_fsm_4, exitcond_fu_225_p2)
    begin
    ...
    exitcond1_fu_144_p2 <= "1" when (loop_reg_76 = ap_const_lv4_8) else "0";
    exitcond2_fu_176_p2 <= "1" when (loop_1_reg_98 = ap_const_lv5_18) else "0";
    ...
    read_3_fu_170_p2 <= std_logic_vector(shift_left(unsigned(read_reg_87),to_integer(unsigned('0' & ap_const_lv8_1(8-1 downto 0)))));
    tmp_9_fu_198_p2 <= "1" when (signed(pos_cast_fu_194_p1) < signed(num)) else "0";
    tmp_s_fu_256_p1 <= std_logic_vector(resize(unsigned(pos_reg_109),64));
end behav;
