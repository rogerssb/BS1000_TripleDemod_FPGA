...
`define AUTOTB_TVIN_size_V  "./c.setupLDPC.autotvin_size_V.dat"
`define AUTOTB_TVIN_rate_V  "./c.setupLDPC.autotvin_rate_V.dat"
`define AUTOTB_TVIN_etaIndexM_V  "./c.setupLDPC.autotvin_etaIndexM_V.dat"
`define AUTOTB_TVIN_etaIndexN_V  "./c.setupLDPC.autotvin_etaIndexN_V.dat"
`define AUTOTB_TVIN_lambdaIndexM_V  "./c.setupLDPC.autotvin_lambdaIndexM_V.dat"
`define AUTOTB_TVIN_din  "./c.setupLDPC.autotvin_din.dat"
`define AUTOTB_TVIN_size_V_out_wrapc  "./rtl.setupLDPC.autotvin_size_V.dat"
`define AUTOTB_TVIN_rate_V_out_wrapc  "./rtl.setupLDPC.autotvin_rate_V.dat"
`define AUTOTB_TVIN_etaIndexM_V_out_wrapc  "./rtl.setupLDPC.autotvin_etaIndexM_V.dat"
`define AUTOTB_TVIN_etaIndexN_V_out_wrapc  "./rtl.setupLDPC.autotvin_etaIndexN_V.dat"
`define AUTOTB_TVIN_lambdaIndexM_V_out_wrapc  "./rtl.setupLDPC.autotvin_lambdaIndexM_V.dat"
`define AUTOTB_TVIN_din_out_wrapc  "./rtl.setupLDPC.autotvin_din.dat"
`define AUTOTB_TVOUT_nR_M_V  "./c.setupLDPC.autotvout_nR_M_V.dat"
`define AUTOTB_TVOUT_etaIndexM_M_V  "./c.setupLDPC.autotvout_etaIndexM_M_V.dat"
`define AUTOTB_TVOUT_etaIndexN_M_V  "./c.setupLDPC.autotvout_etaIndexN_M_V.dat"
`define AUTOTB_TVOUT_pCodeM_V  "./c.setupLDPC.autotvout_pCodeM_V.dat"
`define AUTOTB_TVOUT_pMaxIterations_V  "./c.setupLDPC.autotvout_pMaxIterations_V.dat"
`define AUTOTB_TVOUT_etaIndexM_V  "./c.setupLDPC.autotvout_etaIndexM_V.dat"
`define AUTOTB_TVOUT_etaIndexN_V  "./c.setupLDPC.autotvout_etaIndexN_V.dat"
`define AUTOTB_TVOUT_lambdaIndexM_V  "./c.setupLDPC.autotvout_lambdaIndexM_V.dat"
`define AUTOTB_TVOUT_dout  "./c.setupLDPC.autotvout_dout.dat"
`define AUTOTB_TVOUT_cs  "./c.setupLDPC.autotvout_cs.dat"
`define AUTOTB_TVOUT_clk  "./c.setupLDPC.autotvout_clk.dat"
`define AUTOTB_TVOUT_nR_M_V_out_wrapc  "./impl_rtl.setupLDPC.autotvout_nR_M_V.dat"
`define AUTOTB_TVOUT_etaIndexM_M_V_out_wrapc  "./impl_rtl.setupLDPC.autotvout_etaIndexM_M_V.dat"
`define AUTOTB_TVOUT_etaIndexN_M_V_out_wrapc  "./impl_rtl.setupLDPC.autotvout_etaIndexN_M_V.dat"
`define AUTOTB_TVOUT_pCodeM_V_out_wrapc  "./impl_rtl.setupLDPC.autotvout_pCodeM_V.dat"
`define AUTOTB_TVOUT_pMaxIterations_V_out_wrapc  "./impl_rtl.setupLDPC.autotvout_pMaxIterations_V.dat"
`define AUTOTB_TVOUT_etaIndexM_V_out_wrapc  "./impl_rtl.setupLDPC.autotvout_etaIndexM_V.dat"
`define AUTOTB_TVOUT_etaIndexN_V_out_wrapc  "./impl_rtl.setupLDPC.autotvout_etaIndexN_V.dat"
`define AUTOTB_TVOUT_lambdaIndexM_V_out_wrapc  "./impl_rtl.setupLDPC.autotvout_lambdaIndexM_V.dat"
`define AUTOTB_TVOUT_dout_out_wrapc  "./impl_rtl.setupLDPC.autotvout_dout.dat"
`define AUTOTB_TVOUT_cs_out_wrapc  "./impl_rtl.setupLDPC.autotvout_cs.dat"
`define AUTOTB_TVOUT_clk_out_wrapc  "./impl_rtl.setupLDPC.autotvout_clk.dat"
...
initial begin : generate_done_cnt_proc
    ...
    @(posedge AESL_clock);
    # 0.4;
    fp1 = $fopen("./rtl.setupLDPC.autotvout_nR_M_V.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_nR_M_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_nR_M_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_nR_M_V.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_nR_M_V.dat with impl_rtl.setupLDPC.autotvout_nR_M_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_etaIndexM_M_V.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_etaIndexM_M_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_etaIndexM_M_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_etaIndexM_M_V.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_etaIndexM_M_V.dat with impl_rtl.setupLDPC.autotvout_etaIndexM_M_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_etaIndexN_M_V.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_etaIndexN_M_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_etaIndexN_M_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_etaIndexN_M_V.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_etaIndexN_M_V.dat with impl_rtl.setupLDPC.autotvout_etaIndexN_M_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_pCodeM_V.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_pCodeM_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_pCodeM_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_pCodeM_V.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_pCodeM_V.dat with impl_rtl.setupLDPC.autotvout_pCodeM_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_pMaxIterations_V.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_pMaxIterations_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_pMaxIterations_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_pMaxIterations_V.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_pMaxIterations_V.dat with impl_rtl.setupLDPC.autotvout_pMaxIterations_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_etaIndexM_V.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_etaIndexM_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_etaIndexM_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_etaIndexM_V.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_etaIndexM_V.dat with impl_rtl.setupLDPC.autotvout_etaIndexM_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_etaIndexN_V.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_etaIndexN_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_etaIndexN_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_etaIndexN_V.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_etaIndexN_V.dat with impl_rtl.setupLDPC.autotvout_etaIndexN_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_lambdaIndexM_V.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_lambdaIndexM_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_lambdaIndexM_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_lambdaIndexM_V.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_lambdaIndexM_V.dat with impl_rtl.setupLDPC.autotvout_lambdaIndexM_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_dout.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_dout.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_dout.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_dout.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_dout.dat with impl_rtl.setupLDPC.autotvout_dout.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_cs.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_cs.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_cs.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_cs.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_cs.dat with impl_rtl.setupLDPC.autotvout_cs.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.setupLDPC.autotvout_clk.dat", "r");
    fp2 = $fopen("./impl_rtl.setupLDPC.autotvout_clk.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.setupLDPC.autotvout_clk.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.setupLDPC.autotvout_clk.dat\"!");
    else begin
        $display("Comparing rtl.setupLDPC.autotvout_clk.dat with impl_rtl.setupLDPC.autotvout_clk.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
