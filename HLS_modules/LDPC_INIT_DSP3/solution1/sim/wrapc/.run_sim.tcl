...
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2015.2/win64/tools/fpo_v6_1"
...
upvar ::AESL_AUTOSIM::DirAutoSimRoot  DirAutoSimRoot
    ...
    set gWorkingDir             "../.."
    set constFileTvIn           "setupLDPC.autotvin.dat"
    set constFileTvOut          "setupLDPC.autotvout.dat"
    set constFileHdlTvIn        "setupLDPC.autohdltvin.dat"
    set constFileHdlTvOut       "setupLDPC.autohdltvout.dat"
    set gGateLevelSim           "0"
    set gAutowrap               "1"
    set gTool                   "modelsim"
