...
if {[file isfile setupLDPC.autotvin.dat]} {
    file delete -force setupLDPC.autotvin.dat
}
if {[file isfile setupLDPC.autotvout.dat]} {
    file delete -force setupLDPC.autotvout.dat
}
