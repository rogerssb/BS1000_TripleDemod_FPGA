...
package provide mpy18x18WithCe_xmdf 1.0
...
# is <core_name>_xmdf
namespace eval ::mpy18x18WithCe_xmdf {
...
proc ::mpy18x18WithCe_xmdf::xmdfInit { instance } {
# Variable containg name of library into which module is compiled
# Recommendation: <module_name>
# Required
utilities_xmdf::xmdfSetData $instance Module Attributes Name mpy18x18WithCe
}
# ::mpy18x18WithCe_xmdf::xmdfInit

# Function called by client to fill in all the xmdf* data variables
# based on the current settings of the parameters
proc ::mpy18x18WithCe_xmdf::xmdfApplyParams { instance } {
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount relative_path mpy18x18WithCe.veo
...
utilities_xmdf::xmdfSetData $instance FileSet $fcount associated_module mpy18x18WithCe
incr fcount
