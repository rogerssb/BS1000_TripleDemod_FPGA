...
set_clock_groups -name Clocks -asynchronous -group [get_clocks [get_clocks -of_objects [get_pins SerDes_u/Pll200/inst/mmcm_adv_inst/CLKOUT0]]] -group [get_clocks [list [get_clocks -of_objects [get_pins SerDes_u/PllXn_u/inst/mmcm_adv_inst/CLKOUT1]] [get_clocks -of_objects [get_pins SerDes_u/PllXn_u/inst/mmcm_adv_inst/CLKOUT0]]]] -group [get_clocks MonClk] -group [get_clocks SerDesClk1] -group [get_clocks SerDesClk2]

set_false_path -from [get_ports FPGA_ID*] -to *
