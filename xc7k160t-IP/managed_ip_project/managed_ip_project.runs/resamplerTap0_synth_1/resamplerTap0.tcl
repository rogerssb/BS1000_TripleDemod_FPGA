...
set_property used_in_implementation false [get_files -all c:/modem/vivado/xc7k160t-IP/resamplerTap0/resamplerTap0.dcp]
...
if { [catch {
  write_verilog -force -mode funcsim C:/modem/vivado/xc7k160t-IP/resamplerTap0/resamplerTap0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
if { [catch {
  write_vhdl -force -mode funcsim C:/modem/vivado/xc7k160t-IP/resamplerTap0/resamplerTap0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if {[file isdir C:/modem/vivado/xc7k160t-IP/ip_user_files/ip/resamplerTap0]} {
  catch { 
    file copy -force C:/modem/vivado/xc7k160t-IP/resamplerTap0/resamplerTap0_stub.v C:/modem/vivado/xc7k160t-IP/ip_user_files/ip/resamplerTap0
  }
}

if {[file isdir C:/modem/vivado/xc7k160t-IP/ip_user_files/ip/resamplerTap0]} {
  catch { 
    file copy -force C:/modem/vivado/xc7k160t-IP/resamplerTap0/resamplerTap0_stub.vhdl C:/modem/vivado/xc7k160t-IP/ip_user_files/ip/resamplerTap0
  }
}
