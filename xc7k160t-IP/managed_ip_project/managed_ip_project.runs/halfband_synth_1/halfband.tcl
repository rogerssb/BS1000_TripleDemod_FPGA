...
set_property used_in_implementation false [get_files -all c:/modem/vivado/xc7k160t-IP/halfband/halfband.dcp]
...
if { [catch {
  write_verilog -force -mode funcsim c:/modem/vivado/xc7k160t-IP/halfband/halfband_funcsim.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
if { [catch {
  write_vhdl -force -mode funcsim c:/modem/vivado/xc7k160t-IP/halfband/halfband_funcsim.vhdl
} _RESULT ] } { 
