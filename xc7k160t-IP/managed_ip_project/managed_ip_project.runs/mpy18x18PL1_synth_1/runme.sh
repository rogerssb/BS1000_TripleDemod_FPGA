...
HD_PWD='C:/modem/vivado/xc7k160t-IP/managed_ip_project/managed_ip_project.runs/mpy18x18PL1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mpy18x18PL1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mpy18x18PL1.tcl
