...
module design_2
  ...
  design_2_HLSLdpcLogDecScaledMin_0_0 Decoder_A
       (.ap_clk(clk_wiz_0_clk_out1),
        ...
        .test_port_i({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}));
