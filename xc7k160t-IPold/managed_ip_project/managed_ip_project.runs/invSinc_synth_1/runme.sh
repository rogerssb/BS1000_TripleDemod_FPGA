...
HD_PWD='C:/modem/vivado/xc7k160t-IP/managed_ip_project/managed_ip_project.runs/invSinc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log invSinc.vds -m64 -mode batch -messageDb vivado.pb -notrace -source invSinc.tcl
