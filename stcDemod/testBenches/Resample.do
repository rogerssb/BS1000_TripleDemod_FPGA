...
add wave -noupdate /brik2_tb/Brik2_u/WrInterpRam(0)
...
add wave -noupdate /brik2_tb/Brik2_u/FreqDFT_u/DiffCount
...
add wave -noupdate /brik2_tb/Brik2_u/FreqDFT_u/IlaCount8
add wave -noupdate /brik2_tb/Brik2_u/FreqDFT_u/IlaCount32
...
WaveRestoreCursors {{Cursor 1} {70708000 ps} 0} {{Cursor 2} {70399000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {5299875 ps}
bookmark add wave bookmark18 {{2508730 ps} {2540670 ps}} 0
bookmark add wave bookmark19 {{2187685 ps} {2199857 ps}} 33
bookmark add wave bookmark20 {{3023030 ps} {3054970 ps}} 0
bookmark add wave bookmark21 {{3212803 ps} {3228773 ps}} 48
