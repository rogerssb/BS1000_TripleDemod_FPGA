...
add wave -noupdate /test/enableInput
add wave -noupdate /test/estimatesDone
add wave -noupdate /test/faClkEn
add wave -noupdate /test/faImag
add wave -noupdate /test/faReal
...
add wave -noupdate /test/sample0i
add wave -noupdate /test/sample0r
add wave -noupdate /test/sample1i
add wave -noupdate /test/sample1r
...
add wave -noupdate /test/fa/estimatesDone
...
add wave -noupdate /test/fa/startOfFrame
add wave -noupdate /test/fa/trellisInitCnt
add wave -noupdate /test/fa/wrAddr
add wave -noupdate /test/td/setupComplete
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {11804610000 ps} 0} {{Cursor 2} {464572800 ps} 0} {{Cursor 3} {199216 ps} 0}
...
update
WaveRestoreZoom {0 ps} {529504815 ps}
