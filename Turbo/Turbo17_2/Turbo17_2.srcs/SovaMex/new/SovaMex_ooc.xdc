...
# Here is an example:
create_clock -name clk93 -period 10 [get_ports Clk]

set_multicycle_path -setup 3 -from [get_pins */C] -to [get_pins */D] 
set_multicycle_path -hold  2 -from [get_pins */C] -to [get_pins */D] 
